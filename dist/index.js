        ...
        torrent_module.grabTorrents(query)
            ...
            if (torrentArray.length > 0) {
                ...
                torrentArray.map((torrent) => {
                    torrentList.addFields({ name: `${torrent.number}. ${torrent.title}`, value: `${torrent.magnet} | Seeders: ${torrent.seeds} | Size: ${torrent.size}` });
                });
                ...
                msg.channel.send(new Discord.MessageEmbed()
                    ...
                    .addFields({ name: "Message", value: "Torrent not found in 1337x. Please another query." })
                    .setFooter(Date()));
            }
        });
    }
